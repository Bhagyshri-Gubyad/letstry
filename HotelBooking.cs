...
namespace AirlineReservationSystemCollegeProject
{
    public partial class HotelBooking : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'login_DatabaseDataSet8.TblBookHotelRoom' table. You can move, or remove it, as needed.
            this.tblBookHotelRoomTableAdapter.Fill(this.login_DatabaseDataSet8.TblBookHotelRoom);
