...
using System.Data;
using System;
using AirlineReservationSystemCollegeProject.Login_DatabaseDataSet1TableAdapters;
...
namespace AirlineReservationSystemCollegeProject
{
    public partial class View_Scheduled_Flights : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'login_DatabaseDataSet6.TblFlight' table. You can move, or remove it, as needed.
            this.tblFlightTableAdapter.Fill(this.login_DatabaseDataSet6.TblFlight);
