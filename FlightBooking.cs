...
namespace AirlineReservationSystemCollegeProject
{
    public partial class FlightBooking : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'login_DatabaseDataSet7.BookFlightTicket' table. You can move, or remove it, as needed.
            this.bookFlightTicketTableAdapter.Fill(this.login_DatabaseDataSet7.BookFlightTicket);
            Fillpassenger();
            Fillflight();
            //this.FlightbookDGV.RefreshEdit();
           // FlightbookDGV.Refresh();
        }
