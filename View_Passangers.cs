...
namespace AirlineReservationSystemCollegeProject
{
    public partial class View_Passangers : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'login_DatabaseDataSet5.TblPassanger' table. You can move, or remove it, as needed.
            this.tblPassangerTableAdapter.Fill(this.login_DatabaseDataSet5.TblPassanger);
