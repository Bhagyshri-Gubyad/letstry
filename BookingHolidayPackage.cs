...
namespace AirlineReservationSystemCollegeProject
{
    public partial class BookingHolidayPackage : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'login_DatabaseDataSet9.TblBookHolidayPackage' table. You can move, or remove it, as needed.
            this.tblBookHolidayPackageTableAdapter.Fill(this.login_DatabaseDataSet9.TblBookHolidayPackage);
